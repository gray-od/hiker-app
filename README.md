...
So I built one. Every line of code in this project was written by AI — DeepSeek and Claude, orchestrated through [OpenCode](https://opencode.ai). 21 rounds of development in 4 days. From zero to a deployed product with AI assistant, three languages, and a mobile-first PWA.
