...
const CATEGORIES = [
  ...
  'sweets', 'bread', 'drinks', 'fats', 'spices', 'soups', 'sublimated', 'other',
] as const;
...
export default function FoodPage() {
  ...
  function openEditModal(item: UserFoodItem) {
    setEditingItem(item);
    setFormData({
      name: item.name,
      category: item.category,
      calories_per100g: item.calories_per100g,
      protein_per100g: item.protein_per100g,
      fat_per100g: item.fat_per100g,
      carbs_per100g: item.carbs_per100g,
  ...
  async function handleSave() {
    ...
    const payload = {
      ...
      fat_per100g: formData.fat_per100g,
      carbs_per100g: formData.carbs_per100g,
      default_portion_g: formData.default_portion_g,
    };
    ...
    <div className="flex-1 p-4 md:p-8 max-w-4xl mx-auto w-full">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">{tFood('subtitle')}</p>
        </div>
        <div className="flex items-center gap-2">
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 text-zinc-500 hover:text-[var(--color-brand)] text-sm font-medium rounded-xl transition-colors"
            title={tCommon('print')}
          >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-1">
                      <span className="text-xs text-zinc-400 dark:text-zinc-500">
                        {tFood('default_portion')}: {item.default_portion_g} {tCommon('weight_g')}
                      </span>
                    </div>
                  </div>
