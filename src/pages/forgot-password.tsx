...
export default function ForgotPasswordPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    if (authError) { setGoogleLoading(false); setError(authError.message); }
  };
      ...
      <div className="min-h-screen bg-zinc-50 dark:bg-black">
        <div className="max-w-2xl mx-auto px-4 py-12 md:py-20">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-6 md:p-8">
            ...
            {recoveryUnavailable && (
              <div className="mb-4 p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl text-sm">
                <p className="text-amber-700 dark:text-amber-400 mb-2">{t('recovery_try_google')}</p>
                <button
